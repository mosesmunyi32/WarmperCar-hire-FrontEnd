    ...
    >
                  ...
                  <div className="p-5">
                    <div className="flex flex-col items-center gap-3 py-2 text-center">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mt-1 leading-relaxed">
                          You&apos;ve already booked this car and it&apos;s
                          awaiting confirmation. Edit the details or view your
                          booking.
                        </p>
                      </div>
                      <Button
                        onClick={() => setEditOpen(true)}
                        className="w-full h-10 bg-royal hover:bg-navy text-white font-semibold gap-2"
                      >
      ...
      {existingBooking && (
        <EditBookingModal
          ...
          onUpdated={(updated) => setExistingBooking(updated)}
        />
      )}
    </CustomerLayout>
  )
