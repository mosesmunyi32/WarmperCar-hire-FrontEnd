...
export const bookingService = {
  ...
  createBookingForCustomer: async (
  ...
  recordMileageStart: async (
    ...
    const response = await axiosInstance.patch(
      `/admin/bookings/${id}/mileage-start`,
      data,
    );
    return response.data;
  },
  ...
  getCustomerBookings: async (userId: string): Promise<AdminBooking[]> => {
    const response = await axiosInstance.get(
      `/admin/bookings/customer/${userId}`,
    );
    return response.data;
  },
  ...
  reassignCar: async (
    ...
    const response = await axiosInstance.patch(
      ...
      { newCarNumberPlate: numberPlate, ...(adminNote ? { adminNote } : {}) },
    );
    return response.data;
  },
  ...
  getCarBookingHistory: async (
    carId: string,
  ): Promise<BookingHistoryResponse[]> => {
    const response = await axiosInstance.get(
      `/admin/cars/${carId}/booking-history`,
    );
    return response.data;
  },
  getUserBookingHistory: async (
    ...
    const response = await axiosInstance.get(
      `/admin/customers/${userId}/booking-history`,
    );
    return response.data;
  },
  ...
  getMyExtensions: async (): Promise<BookingExtensionResponse[]> => {
    const response = await axiosInstance.get(
      "/bookings/extensions/my-extensions",
    );
    return response.data;
  },
  getExtensionsByBookingId: async (
    bookingId: string,
  ): Promise<BookingExtensionResponse[]> => {
    const response = await axiosInstance.get(
      `/admin/bookings/${bookingId}/extensions`,
    );
    return response.data;
  },
  ...
  approveOrRejectExtension: async (
    data: ApproveBookingExtensionRequest,
  ): Promise<BookingExtensionResponse> => {
    const response = await axiosInstance.patch(
      "/admin/extensions/approve",
      data,
    );
    return response.data;
  },
